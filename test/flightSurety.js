...
contract('Flight Surety Tests', async (accounts) => {
  ...
  it('(airline) Only existing airline may register a new airline until there are at least four airlines registered', async () => {
    ...
    let result = await config.flightSuretyData.isRegisteredAirline.call(newAirline, {from: config.owner}); 

    // ASSERT
    assert.equal(result, true, "Airline registered should be able to register until there are at least four airlines registered");
